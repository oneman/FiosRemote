...
def construct_fios_remote_packet_PNGARB2(filename)
png_packet_header = %w{56 02 02 01 00 27 00 00} + [$hours, $minutes, $seconds] + %w{00 00 00 00 00
00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00
00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00
00 00 00 00 00 00 00 00 00 00 00 00 00 00 0a 00
00 00 00 00 12 8d 01 00 00 02 00 02 00 01 14 00
04 00 00 46 9d 17 00 02 00 02 03 46 9d}
png_image = ""
...
if commands.has_value? cmd
 ...
 unless ['help','quit','resendpng','resendinit2', 'resendinit2andpng'].include? cmd
